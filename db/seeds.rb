...
I18n.locale = "es"
Program.create(name: "Ritmos Negros del Perú", description: "Una muestra de nuestra cultura afroperuana a través de su música, distinguida por una percusión única.", radio_id: 1, program_start: "2000-01-01 08:00:00", program_end: "2000-01-01 09:59:59", days_array: "1,2,3,4,5,6,7")
Program.create(name: "Ritmos Negros del Perú", description: "Una muestra de nuestra cultura afroperuana a través de su música, distinguida por una percusión única.", radio_id: 1, program_start: "2000-01-01 20:00:00", program_end: "2000-01-01 20:59:59", days_array: "1,2,3,4,5,6,7")
Program.create(name: "Canción de Autor", description: "Cantautores peruanos en su máxima expresión.", radio_id: 1, program_start: "2000-01-01 10:00:00", program_end: "2000-01-01 10:59:59", days_array: "1,2,3,4,5,6,7")
Program.create(name: "Canción de Autor", description: "Cantautores peruanos en su máxima expresión.", radio_id: 1, program_start: "2000-01-01 16:00:00", program_end: "2000-01-01 16:59:59", days_array: "1,2,3,4,5,6,7")
Program.create(name: "Canción de Autor", description: "Cantautores peruanos en su máxima expresión.", radio_id: 1, program_start: "2000-01-01 22:00:00", program_end: "2000-01-01 22:59:59", days_array: "1,2,3,4,5,6,7")
Program.create(name: "Alma Criolla", description: "Criollismo puro y de todo el Perú.", radio_id: 1, program_start: "2000-01-01 14:00:00", program_end: "2000-01-01 15:59:59", days_array: "1,2,3,4,5,6,7")
Program.create(name: "Alma Criolla", description: "Criollismo puro y de todo el Perú.", radio_id: 1, program_start: "2000-01-01 21:00:00", program_end: "2000-01-01 21:59:59", days_array: "1,2,3,4,5,6,7")
Program.create(name: "Varios de la Costa", description: "Música criolla y ritmos negros unidos.", radio_id: 1, program_start: "2000-01-01 11:00:00", program_end: "2000-01-01 13:59:59", days_array: "1,2,3,4,5,6,7")
Program.create(name: "Varios de la Costa", description: "Música criolla y ritmos negros unidos.", radio_id: 1, program_start: "2000-01-01 17:00:00", program_end: "2000-01-01 19:59:59", days_array: "1,2,3,4,5,6,7")
Program.create(name: "Varios de la Costa", description: "Música criolla y ritmos negros unidos.", radio_id: 1, program_start: "2000-01-01 11:00:00", program_end: "2000-01-01 13:59:59", days_array: "1,2,3,4,5,6,7")
Program.create(name: "Varios de la Costa", description: "Música criolla y ritmos negros unidos.", radio_id: 1, program_start: "2000-01-01 23:00:00", program_end: "2000-01-01 07:59:59", days_array: "1,2,3,4,5,6,7")


I18n.locale = "en"
Format.find(1).update_attributes(name:"Black Rythms of Perú", description: "A sign of our Afro-Peruvian culture through its music, distinguished by its unique percussion.")
Format.find(2).update_attributes(name:"Black Rythms of Perú", description: "A sign of our Afro-Peruvian culture through its music, distinguished by its unique percussion.")
Format.find(3).update_attributes(name:"Singer/Songwriters", description: "Peruvian singer/songwriters at their best.")
Format.find(4).update_attributes(name:"Singer/Songwriters", description: "Peruvian singer/songwriters at their best.")
Format.find(5).update_attributes(name:"Singer/Songwriters", description: "Peruvian singer/songwriters at their best.")
Format.find(6).update_attributes(name:"Creole Soul", description: "Puro Creole music and from all regions.")
Format.find(7).update_attributes(name:"Creole Soul", description: "Puro Creole music and from all regions.")
Format.find(8).update_attributes(name:"Various from the Coast", description: "Creole music and black rhythms together.")
Format.find(9).update_attributes(name:"Various from the Coast", description: "Creole music and black rhythms together.")
Format.find(10).update_attributes(name:"Various from the Coast", description: "Creole music and black rhythms together.")
Format.find(11).update_attributes(name:"Various from the Coast", description: "Creole music and black rhythms together.")
