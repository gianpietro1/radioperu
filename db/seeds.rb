...
Genre.find_by_id(1).set_translations(:en => { :name => 'Creole' })
Genre.find_by_id(2).set_translations(:en => { :name => 'Trova' })
Genre.find_by_id(3).set_translations(:en => { :name => 'Canción de Autor' })
Genre.find_by_id(4).set_translations(:en => { :name => 'Afro-Peruvian' })
Genre.find_by_id(5).set_translations(:en => { :name => 'Andean' })
Genre.find_by_id(6).set_translations(:en => { :name => 'Salsa' })
Genre.find_by_id(7).set_translations(:en => { :name => 'Cumbia' })
Genre.find_by_id(8).set_translations(:en => { :name => 'Chicha' })
Genre.find_by_id(9).set_translations(:en => { :name => 'Tropical' })
Genre.find_by_id(10).set_translations(:en => { :name => 'Techno-cumbia' })
Genre.find_by_id(11).set_translations(:en => { :name => 'Rock' })
Genre.find_by_id(12).set_translations(:en => { :name => 'Pop' })
Genre.find_by_id(13).set_translations(:en => { :name => 'Reggae' })
Genre.find_by_id(14).set_translations(:en => { :name => 'Metal' })
Genre.find_by_id(15).set_translations(:en => { :name => 'Funk' })
Genre.find_by_id(16).set_translations(:en => { :name => 'Fusion' })
Genre.find_by_id(17).set_translations(:en => { :name => 'Ballad' })
Genre.find_by_id(18).set_translations(:en => { :name => 'Hip Hop' })
Genre.find_by_id(19).set_translations(:en => { :name => 'New Wave' })
Genre.find_by_id(20).set_translations(:en => { :name => 'Punk' })
Genre.find_by_id(21).set_translations(:en => { :name => 'Ska' })
Genre.find_by_id(22).set_translations(:en => { :name => 'Rap' })
Genre.find_by_id(23).set_translations(:en => { :name => 'Electronica' })
Genre.find_by_id(24).set_translations(:en => { :name => 'Classic' })
Genre.find_by_id(25).set_translations(:en => { :name => 'Jazz' })
Genre.find_by_id(26).set_translations(:en => { :name => 'World Music' })
Genre.find_by_id(27).set_translations(:en => { :name => 'Academic' })
Genre.find_by_id(28).set_translations(:en => { :name => 'Instrumental Fusion' })
