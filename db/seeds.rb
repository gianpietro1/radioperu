...
Program.find(20).update_attributes(name:"Various from Tropical Music", description: "Salsa, Cumbia, Chicha, Boogaloo and more tropical rythms.")
Program.find(21).update_attributes(name:"Cumbia from All Times", description: "Cumbia from all times.")
Program.find(22).update_attributes(name:"Cumbia from All Times", description: "Cumbia from all times.")
Program.find(23).update_attributes(name:"Salsa from All Times", description: "Salsa from all times.")
Program.find(24).update_attributes(name:"Salsa from All Times", description: "Salsa from all times.")

Program.find(25).update_attributes(name:"Time for Reggae", description: "Only reggae music.")
Program.find(26).update_attributes(name:"Time for Reggae", description: "Only reggae music.")
...
Program.find(28).update_attributes(name:"RockOla from Yesteryear", description: "Rock, Nueva Ola & psychedelic rythms from the 60s & 70s.")
Program.find(29).update_attributes(name:"Must-hear Fusions", description: "Fusion music from all times: rock & peruvian rythms!")
Program.find(30).update_attributes(name:"Must-hear Fusions", description: "Fusion music from all times: rock & peruvian rythms!")
Program.find(31).update_attributes(name:"SkaFunk", description: "Ska & Funk from all times.")
Program.find(32).update_attributes(name:"SkaFunk", description: "Ska & Funk from all times.")
Program.find(33).update_attributes(name:"Hard Rock & Punk", description: "Hard Rock & Punk music.")
Program.find(34).update_attributes(name:"Hard Rock & Punk", description: "Hard Rock & Punk music.")
Program.find(35).update_attributes(name:"Rocks, Pops & More", description: "Rock, Pop, Funk, Hip-Hop & more!")
Program.find(36).update_attributes(name:"Rocks, Pops & More", description: "Rock, Pop, Funk, Hip-Hop & more!")
